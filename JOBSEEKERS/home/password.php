...
global $db, $commonQueries, $jobseeker_profile;
...
if (isset($_POST['submit'])){
    ...
    if (password_verify($current_password, $jobseeker_profile['password'])){//Password matched
        //Change user password
        if(!$db->where('username', "$AuthUserName")->update('jobseekers', array('password' => "$new_password"))){
