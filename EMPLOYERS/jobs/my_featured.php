...
$id=$_REQUEST["id"];    
$website->ms_i($id);
$job_by_employer = $db->get_data('jobs','', "WHERE employer = '$AuthUserName' AND id=$id LIMIT 1");
...
<?php
if(get_param("featured")=="1") //Make featured section
{
...
<br><br><br>
	...
	(
		...
		$id,
		"featured_expires",
		$job_by_employer[0]['date']+86400*$website->GetParam("FEATURED_ADS_EXPIRE") // 86400 = 1 day
	);	
